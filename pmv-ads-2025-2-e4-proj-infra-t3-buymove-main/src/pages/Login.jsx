...
export default function Login() {
  ...
  const buttonClass =
    "inline-flex w-full items-center justify-center rounded-full bg-blue-900 px-6 py-3 text-sm font-semibold text-white transition hover:bg-blue-800";
      ...
      <section className="space-y-8">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          <p className="text-sm text-slate-600">
            Logado como <span className="font-semibold text-blue-900">{user.email}</span>.
          </p>
    ...
    <section className="space-y-8">
      ...
      >
        ...
        <p className="text-xs text-slate-400">
          Esta é somente uma experiência de autenticação. A autenticação real será conectada ao backend em breve.
        </p>
